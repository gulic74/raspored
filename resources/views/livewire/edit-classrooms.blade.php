<div>
    @if (strpos(url()->previous(), 'classrooms/create') !== false)
        <div class="flex items-center bg-green-500 text-white text-sm font-bold px-4 py-3 relative" role="alert" x-data="{show: true}" x-show="show">
            ...
            <p>Uspješno je stvorena nova učionica!</p>
    ...
    <form method="POST" name="formaStvoriUcionicu" action="">
        ...
        <div wire:click="createClassroom()" class='mt-4 bg-blue-500 hover:bg-blue-700 text-white py-2 px-3 rounded-lg inline-block align-middle' style="text-decoration:none; cursor: pointer;">Ažuriraj učionicu</div>
    </form>
</div>
