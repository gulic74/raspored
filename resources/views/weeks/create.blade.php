                ...
                <form action="{{ route('weeks.store') }}" method="POST">
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="number" name="ime" id="ime" placeholder="Unesite numerički broj" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>
                        ...
                        <div class="col-span-6">
                            ...
                            <input type="date" name="datum_pocetka" id="datum_pocetka" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>
