<x-jet-form-section submit="updateProfileInformation">
    <x-slot name="title">
        <span style="color: white">{{ __('Profile Information') }}</span>
    </x-slot>

    <x-slot name="description">
        <span style="color: rgb(207, 207, 207)">{{ __('Update your account\'s profile information and email address.') }}</span>
    </x-slot>
