<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @auth
                        @if (Auth::user()->is_admin === 1)
                            <x-jet-nav-link href="{{ route('terms.index') }}"  :active="request()->routeIs('terms.index')">
                                {{ __('Termini') }}
                            </x-jet-nav-link>
                        ...
                        @endif
                        <x-jet-nav-link href="{{ route('classrooms.index') }}"  :active="request()->routeIs('classrooms.index')">
                            {{ __('Učionice') }}
                        </x-jet-nav-link>
                    
                        <x-jet-nav-link href="{{ route('users.show', ['id' => Auth::user()->id]) }}"  :active="request()->routeIs('users.show', ['id' => Auth::user()->id])">
                            {{ __('Opterećenje') }}
                        </x-jet-nav-link>
                        <!--<x-jet-nav-link href="{{ route('classrooms.occupancy') }}"  :active="request()->routeIs('classrooms.occupancy')">
                            {{ __('Zauzetost učionica') }}
                        </x-jet-nav-link>-->
                            ...
                            <div class="mt-6"> 
                                <x-jet-dropdown>
                                    ...
                                    <x-slot name="content">            
                                        ...
                                        <x-jet-dropdown-link href="{{ route('parttimeschedule.indexcreate') }}"  :active="request()->routeIs('parttimeschedule.indexcreate')">
                                            {{ __('IZV slaganje') }}
                                        </x-jet-dropdown-link> 
                                    </x-slot>          
                                </x-jet-dropdown>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                @if (Auth::user()->is_admin === 1)
                    <x-jet-responsive-nav-link href="{{ route('terms.index') }}"  :active="request()->routeIs('terms.index')">
                        {{ __('Termini') }}
                    </x-jet-responsive-nav-link>
                ...
                <x-jet-responsive-nav-link href="{{ route('classrooms.index') }}"  :active="request()->routeIs('classrooms.index')">
                    {{ __('Učionice') }}
                </x-jet-responsive-nav-link>
                
            
                <x-jet-responsive-nav-link href="{{ route('users.show', ['id' => Auth::user()->id]) }}"  :active="request()->routeIs('users.show', ['id' => Auth::user()->id])">
                    {{ __('Opterećenje') }}
                </x-jet-responsive-nav-link>
                <!--<x-jet-responsive-nav-link href="{{ route('classrooms.occupancy') }}"  :active="request()->routeIs('classrooms.occupancy')">
                    {{ __('Zauzetost učionica') }}
                </x-jet-responsive-nav-link>-->
