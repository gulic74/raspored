...
class CreateTerms extends Component
{
    public $termin;
    ...
    public function mount()
    {
        ...
        $this->pocetak = 8;
        $this->tip = 'PREDAVANJE';
        $this->pred_vj = 'PREDAVANJE';
        $this->grupa = "svi";
        $this->dan = 'pon';
        $this->dan_selected = 'pon';
        $this->semestar = 'ZIMSKI';
        $this->semestar_selected = 'ZIMSKI';
        $this->komentar = "";
        $this->napomena = "";
        ...
        //     $this->odabirKolegij[$kolegijTrenutni->id] = $kolegijTrenutni->ime . " - " . $kolegijTrenutni->smjer;
        // }
    }
            ...
            if($this->aktivan == 1){
                ...
                if($this->kolizija == 0){
                    ...
                    foreach($this->odabirProfesor as $key => $value) {
                        ...
                        $userTermNovo->term_id = $termDetails->id;
                        $userTermNovo->save();
                    }                   
                    ...
                    foreach($this->odabirKolegij as $key => $value) {
                        ...
                        $courseTermNovo->term_id = $termDetails->id;
                        $courseTermNovo->save();
                    }
                    ...
                    foreach($this->odabirUcionica as $key => $value) {
                        ...
                        $classroomTermNovo->term_id = $termDetails->id;
                    ...
                    return redirect()->to("terms/edit/" . $termDetails->id . "");
                }
            } else {
    ...
    public function render()
    {
        ...
        return view('livewire.create-terms', ['users' => $this->users,
